...
<html lang ="fr">
    <head>
        <meta charset = "utf-8">
        <meta name="recherche.php" content="recherche.php">
    ...
    <body>
        ...
        <div class = "conteneur">
                <h2> Vous rechercher un jeu en particulier ? Saissez les informations ici !</h2>
                ...
                <button type = "submit" name="envoi"> Rechercher </button>
                </form>
                </section>
                </div>
        </section>
